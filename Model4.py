...
class Model4:
    ...
    def build_graph(self):
        ...
        # Prepare for RNN
        cnn_out = tf.reshape(conv4, shape=(-1, self.maxVidLen, 2 * 3 * 128))
        ...
        dense1 = tf.layers.dense(lstm_out, 512)
        # Output layer
        logits = tf.layers.dense(dense1, len(self.char2index))
